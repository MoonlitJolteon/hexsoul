...
import hexdoc_hexsoul

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexsoulPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexsoulModPlugin(branch=branch)


class HexsoulModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexsoul"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexsoul, "_templates"
